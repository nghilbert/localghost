...
export function ButtonGroup({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: role="group" is right for a toolbar-style button cluster. A <fieldset> carries form-field UA styling and legend semantics this is not.
		<div
			role="group"
